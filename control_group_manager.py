...
class ControlGroupManager:
  def create_group(self, request):
    group = models.ControlGroup(name=request.name, email=request.email, latitude=request.latitude, longitude=request.longitude, radius=request.radius*METERS_PER_MILE)
